                ...
                <div class="card-content">
                    <form action="{{ route('transaksi_admin_update', $transaksi->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="blok" name="blok" readonly
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="promosi" name="promosi" readonly
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggal_bayar" name="tanggal_bayar" readonly
